...
class FiltersModel(QtGui.QStandardItemModel):
    ...
    def _addDefaultTreeItems(self):
        self._allTasksItem = FilterItem(self, 'Todas', AllTasksFilter(), 'qtodotxt-filter-all')
        self._uncategorizedTasksItem = FilterItem(self, 'Sin Categoría',
                                                  UncategorizedTasksFilter(), 'qtodotxt-filter-uncategorized')
        self._dueItem = FilterItem(self, 'Vencimiento', HasDueDateFilter(), 'qtodotxt-filter-due')
        self._contextsItem = FilterItem(self, 'Contextos', HasContextsFilter(), 'qtodotxt-filter-contexts')
        self._projectsItem = FilterItem(self, 'Proyectos', HasProjectsFilter(), 'qtodotxt-filter-projects')
        self._priorityItem = FilterItem(self, 'Prioridades', HasPriorityFilter(), 'qtodotxt-filter-complete')
        self._completeTasksItem = FilterItem(self, 'Completas', CompleteTasksFilter(), 'qtodotxt-filter-complete')
