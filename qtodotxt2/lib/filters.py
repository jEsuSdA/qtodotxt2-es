...
class DueTomorrowFilter(BaseFilter):
    ...
    def __init__(self):
        BaseFilter.__init__(self, "Mañana")
...
class DueThisWeekFilter(BaseFilter):
    ...
    def __init__(self):
        BaseFilter.__init__(self, "Esta semana")
...
class DueThisMonthFilter(BaseFilter):
    ...
    def __init__(self):
        BaseFilter.__init__(self, "Este mes")
...
class DueOverdueFilter(BaseFilter):
    ...
    def __init__(self):
        BaseFilter.__init__(self, "Atrasadas")
